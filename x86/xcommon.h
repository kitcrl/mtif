...
#endif
#endif
long double ___round(long double p, int32_t n);
...
#endif
#endif
int32_t __get_ini_value(int8_t*, int8_t*, int8_t*, int8_t, int8_t, int8_t*);
...
__declspec(dllexport)
#endif
int32_t __get_files(int8_t* dname, int8_t* list, int32_t* count);
...
#endif
#endif
int8_t* __get_curr_time(int8_t*p, int8_t* arg0, int8_t* arg1, int8_t* arg2, int8_t* arg3,
                  int32_t* YY, int32_t* MM, int32_t* DD, int32_t* hh, int32_t* mm, int32_t* ss, int32_t* us);
...
#endif
#endif
int32_t __asc_to_hex(uint8_t asc);
