...
int32_t __sifr_kat_check(void* h,uint8_t*);
int32_t __sifr_self_check(void* h, int8_t*, int32_t);

int32_t __sifr_base64(void*, uint8_t*, int32_t, uint8_t, uint8_t*, void*, void*);

int32_t __sifr_rand(void*, uint8_t*, int32_t, uint8_t*, int32_t, uint8_t*, int32_t);
...
int32_t __sifr_initia(void** h);
int32_t __sifr_finelia(void** h)
